...
<div id="wrapper">
  ...
  <?php if($_SESSION['role']!="family") echo "<li><a href='ShowVenues.php'>Plan a wedding</a></li> ";?>        
   ...
   <?php if($_SESSION['role']!="family") echo "<li><a href='SummaryReport.php' >Summarize Vendors</a></li> ";?>   
        <li class="last"><a href="#" class="active">Contact Dream events</a></li>
      </ul>
    </div>
   ...
   <div style="color:black; text-align:center;">
           <b>
    		<br><span style="color:red;font-size:15px;">Dream EventZ</span></br>
        		<br>IIIT-Hyderabad,</br>
        		<br>Gachibowli, Hyderabad - 32.</br>
        		<br>Contact +91 9703060103 ; +91 8106199128</br>
        		<br>Email: <a href="mailto:dreameventzservices@gmail.com">dreameventzservices@gmail.com</a></br>
    		</b>
   </div>  
        </div>
      </div>
