...
var fnHal="";
  ...
  function function1()
  {
      ...
      selection1 = table1.getSelection();
          fnHal+= data1.getValue(selection1[selection1.length-1].row,1)+" \n ";
          ven1+= data1.getValue(selection1[selection1.length-1].row,0)+",";
  }
  function function2()
  {
      //alert();
      selection2 = table2.getSelection();
          cater+= data2.getValue(selection2[selection2.length-1].row,1)+" \n ";
          ven2+= data2.getValue(selection2[selection2.length-1].row,0)+",";
  }
  function function3()
  {
      //alert();
      selection3 = table3.getSelection();
          decor+= data3.getValue(selection3[selection3.length-1].row,1)+" \n ";
          ven3+= data3.getValue(selection3[selection3.length-1].row,0)+",";
  }
  function function4()
  {
      //alert();
      selection4 = table4.getSelection();
          photo+= data4.getValue(selection4[selection4.length-1].row,1)+" \n ";
          ven4+= data4.getValue(selection4[selection4.length-1].row,0)+",";
  }
